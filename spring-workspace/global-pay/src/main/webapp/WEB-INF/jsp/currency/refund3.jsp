             ...
             <ul class="list-group">
               ...
               <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                 <div class="d-flex flex-column">
		            ...
		            <div class="d-flex">
		              <h6 class="mb-0 me-5 opacity-7">환불 금액</h6>
		              <h6 class="mb-0">${refundHistory.feAmount } &nbsp; ${refundHistory.currencyEn }
		              </h6>
		            </div>
		            <hr class="horizontal dark">
		            <div class="d-flex">
		              <h6 class="mb-0 me-5 opacity-7">외화 잔액</h6>
		              <h6 class="mb-0">${balance }&nbsp; ${refundHistory.currencyEn }
		              </h6>
		            </div>
		            ...
		            <hr class="horizontal dark">
		            <div class="d-flex">
		              <h6 class="mb-0 me-5 opacity-7">입금 금액</h6>
		              <h6 class="mb-0">${refundHistory.krAmount } 원 </h6>
		            </div>
